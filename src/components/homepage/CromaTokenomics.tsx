          ...
          <GlassBox baseColor='orange'>
            ...
            <div className='mb-6 px-4 py-8 lg:p-8 2xl:p-10 text-center'>
              ...
              <GlassBox baseColor='white'>
                <div className='xl:px-8 py-4 2xl:py-6 backdrop-blur-[50px] rounded-[20px]'>
                ...
                <div className='grid grid-cols-1 lg:grid-cols-2 gap-2 lg:gap-4 text-left'>
                  {dataCrcToken.map(({title, desc, icon}) => (
                    <GlassBox baseColor='primary' key={title}>
                      <div className='p-4 2xl:p-6 flex items-start gap-2.5 rounded-[20px] backdrop-blur-[20px] h-full bg-[linear-gradient(rgba(252,100,0,0.08),rgba(252,100,0,0.08)),linear-gradient(rgba(0,0,0,0.34),rgba(0,0,0,0.34))]'>
                        <Image 
                          src={icon}
                          alt={`Icon ${title}`}
                          width={42}
