...
import Heading from '@/app/whitepaper/Heading';
import Paragraph from '@/app/whitepaper/Paragraph';
import SubHeading from '@/app/whitepaper/SubHeading';
import SubSubHeading from '@/app/whitepaper/SubSubHeading';
...
const Whitepaper = () => {
  ...
  return (
    <>
    <div className='-z-10 absolute -top-[350px] -left-[350px] size-[600px] lg:size-[900px] rounded-full bg-[radial-gradient(circle_at_center,#FC6400_0%,rgba(242,39,174,0)_70%)] blur-3xl opacity-80'></div>
    ...
    <header className='relative pt-[160px] h-full mx-4 md:mx-[100px] flex flex-col gap-4 items-center justify-between text-center'>
      <h1 className='font-black text-3xl lg:text-[80px] uppercase'>
      ...
      <p className={`${poppins.className} text-base lg:text-xl font-medium max-w-[780px]`}>
        A community-centric project championing creativity, transparency, and collective strength in the world of crypto art
      </p>
    </header>
    <section className='px-4 lg:px-15 2xl:px-[100px] pt-14'>
      <GlassBox baseColor='orange'>
        <div className='p-4 lg:p-10 flex flex-col items-center justify-center backdrop-blur-[50px]'>
          <h2 className='text-2xl lg:text-[32px] font-semibold leading-[120%] text-white'>
            Table of Contents
          </h2>
          <p className={`${poppins.className} mt-4 text-base lg:text-xl font-medium text-[#E9E9E9] opacity-80`}>
          ...
          <div className='w-full flex flex-col md:flex-row justify-around items-start px-8'>
            <ol className={`${poppins.className} mt-10 opacity-80`}>
                ...
                <Link href={`#${id}`} key={id}>
                  <li className='text-lg lg:text-2xl font-medium text-[#E9E9E9] leading-[50px] list-decimal hover:text-[#FC6400] transition-all duration-300'>
                    {title}
                  </li>
                </Link>
                ))}
            ...
            <ol start={half + 1} className={`${poppins.className} mt-10 opacity-80`}>
                ...
                <Link href={`#${id}`} key={id} >
                  <li className='text-lg lg:text-[22px] 2xl:text-2xl font-medium text-[#E9E9E9] leading-[50px] list-decimal hover:text-[#FC6400] transition-all duration-300'>
                    {title}
                  </li>
                </Link>
                ))}
    ...
    <section className={`${poppins.className} px-4 lg:px-15 2xl:px-[100px] py-8 lg:py-14 flex flex-col text-white`}>
      ...
      <article id='summary' className='scroll-mt-[140px] pt-[60px]'>
        ...
        <GlassBox baseColor='orange'>
          <div className='px-4 py-8 lg:px-[60px] lg:py-10 backdrop-blur-[50px]'>
            <SubHeading>Dual-Token Ecosystem</SubHeading>
            <div className='mt-6 flex flex-col lg:flex-row w-full justify-between gap-8'>
              <div className='w-full lg:max-w-1/2 space-y-2 lg:space-y-10'>
            ...
            <div className='h-fit mt-2'>
              <GlassBox baseColor='orange'>
                <div className='p-6 backdrop-blur-[50px]'>
                  <p className='text-sm lg:text-xl font-medium leading-[120%] italic'>
        ...
        <div className='mt-8 grid grid-cols-1 lg:grid-cols-2 gap-4'>
          {features.map(({title, content}) => (
            <GlassBox baseColor='orange' key={title}>
              <div className='px-4 py-8 lg:p-10 flex flex-col gap-3 lg:gap-6 backdrop-blur-[50px]'>
      ...
      <article id='tokenomics' className='scroll-mt-[140px] pt-[60px]'>
        ...
        <div className='mt-8'>
          <GlassBox baseColor='orange'>
            <div className='px-4 py-8 lg:px-[60px] lg:py-10 space-y-5 lg:space-y-10 backdrop-blur-[50px]'>
              <div className='flex flex-col lg:flex-row'>
                <div className='w-full lg:max-w-1/2 space-y-3 lg:space-y-6'>
              ...
              <GlassBox baseColor='orange'>
                <div className='px-4 py-8 lg:p-10 backdrop-blur-[50px]'>
      ...
      <article id='ecosystem' className='scroll-mt-[140px] pt-[60px]'>
        ...
        <div className='my-8'>
          <GlassBox baseColor='orange'>
            <div className='px-4 py-8 lg:p-10 flex flex-col justify-center items-center gap-6 backdrop-blur-[50px]'>
              <SubSubHeading>
              ...
              <ButtonPrimary>
                <Link href={URLS.cromachain} target='_blank' className={`${orbitron.className}`}>
                    View Cromachain
                </Link>
              </ButtonPrimary>
            </div>
        ...
        <div className='mt-6 mb-8 grid grid-cols-1 lg:grid-cols-3 gap-4'>
          {coreTechnologies.map(({title, desc, listTexts}) => (
            <GlassBox baseColor='orange' key={title}>
              <div className='px-4 py-8 lg:p-10 space-y-4 lg:space-y-8 backdrop-blur-[50px]'>
                <SubSubHeading>
                  {title}
                </SubSubHeading>
                <div>
        ...
        <table className='table-auto mt-6 mb-8 text-white w-full text-left'>
          <thead className='md:w-[30%] bg-gradient-to-r from-[#B72204] to-[#FC6400] border border-[#818181]'>
            <tr>
              <th className='px-2 lg:px-6 py-1 lg:py-3 text-base lg:text-[22px] 2xl:text-2xl font-medium tracking-[-0.04%] leading-[38px]'>
                Component
              </th>
              <th className='px-2 lg:px-6 py-1 lg:py-3 text-base lg:text-[22px] 2xl:text-2xl font-medium tracking-[-0.04%] leading-[38px]'>
                Function
          ...
          <tbody>
            {modularArchitecture.map(({title, desc}, index) => {
              ...
              <tr key={index} className={`${bgStyle} border border-[#818181]`}>
                <td className='px-2 lg:px-6 py-1 lg:py-3 text-base lg:text-[22px] 2xl:text-2xl tracking-[-0.04%] leading-[38px]'>
                  {title}
                </td>
                <td className='px-2 lg:px-6 py-1 lg:py-3 text-base lg:text-[22px] 2xl:text-2xl tracking-[-0.04%] leading-[38px]'>
                  {desc}
        ...
        <div className='mt-6 mb-8 grid grid-cols-1 lg:grid-cols-2 gap-4'>
          <GlassBox baseColor='orange'>
            <div className='px-4 py-8 lg:p-10 space-y-6 backdrop-blur-[50px]'>
          ...
          <div className='xl:col-span-2'>
            <GlassBox baseColor='orange'>
              <div className='px-4 py-8 lg:p-10 text-center lg:text-left backdrop-blur-[50px]'>
                <SubSubHeading>Performance Benchmarks</SubSubHeading>
                <div className={`${orbitron.className} mt-6 grid grid-cols-2 lg:grid-cols-4 gap-4`}>
                  {performanceBenchmark.map(({title, desc}) => (
                    <div key={title} className='flex flex-col items-center gap-2.5 text-center'>
                      <span className='text-2xl lg:text-3xl 2xl:text-4xl font-bold leading-[120%] text-white'>{title}</span>
                      <span className='text-sm lg:text-base font-semibold leading-[120%] text-[#E9E9E9] opacity-60'>{desc}</span>
                    </div>
                  ))}
                </div>
              </div>
        ...
        <div className='space-y-8'>
          ...
          <GlassBox baseColor='orange'>
            <div className='px-4 py-8 lg:px-[60px] lg:py-10 backdrop-blur-[50px]'>
              ...
              <div className='mt-6 mb-8 flex flex-col lg:flex-row w-full justify-between gap-8'>
                <div className='w-full lg:max-w-1/2'>
                  ...
                  <div className='mt-4 h-fit'>
                    <GlassBox baseColor='orange'>
                      <div className='px-4 py-6 lg:p-6 backdrop-blur-[50px]'>
                        <span className='text-sm lg:text-xl italic text-white'>
              ...
              <div className='mt-6 mb-8 grid grid-cols-1 lg:grid-cols-2 gap-x-4 gap-y-6'>
                <GlassBox baseColor='orange'>
                  <div className='px-4 py-8 lg:p-10 space-y-6 backdrop-blur-[50px]'>
      ...
      <article id='launch-timeline' className='scroll-mt-[140px] pt-[60px]'>
        <div className='space-y-8'>
          ...
          <div>
            <h4 className='text-[22px] lg:text-2xl font-medium text-white tracking-[-0.04%]'>
              CRM Token Launch
            </h4>
      ...
      <article id='art-platform' className='scroll-mt-[140px] pt-[60px]'>
        <div className='space-y-8'>
          ...
          <div>
            <h4 className='mb-4 text-[22px] lg:text-2xl font-medium text-white tracking-[-0.04%]'>
      ...
      <article id='automatic-staking' className='scroll-mt-[140px] pt-[60px]'>
        <div className='space-y-8'>
          ...
          <GlassBox baseColor='orange'>
            <div className='px-4 py-8 lg:px-[60px] lg:py-10 space-y-6 backdrop-blur-[50px]'>
              <div className='space-y-4'>
              ...
              <GlassBox baseColor='orange'>
                <div className='px-4 py-6 lg:p-6 backdrop-blur-[50px]'>
                  <p className='text-base lg:text-2xl text-white mb-4'>Example Calculation:</p>
      ...
      <article id='risks-disclaimer' className='scroll-mt-[140px] pt-[60px]'>
        ...
        <div className={`mt-8 relative px-4 py-8 lg:p-10 h-full overflow-hidden rounded-[20px] border border-[#FF2020] bg-[linear-gradient(rgba(201,103,103,0.2),rgba(201,103,103,0.2)),linear-gradient(rgba(0,0,0,0.34),rgba(0,0,0,0.34))] space-y-4 backdrop-blur-[50px]`}>
          <Paragraph opacity={60}>
        ...
        <div className='mt-8 text-center'>
          <GlassBox baseColor='orange'>
            <div className='px-4 py-8 lg:p-10 space-y-6 backdrop-blur-[50px]'>
              ...
              <p className='italic text-sm lg:text-xl text-[#E9E9E9] opacity-60 font-medium'>
                'The future of Web3 is not defined by code — it is shaped by accessibility, trust, and transparency.'
              </p>
            </div>
          </GlassBox>
